 ...
 */
public class AllerginListViewItemAdapter extends ArrayAdapter<String> {
    private int layout;
    List <String> data = null;
    Context context;

    public AllerginListViewItemAdapter(Context context, int resource, List<String> objects) {
