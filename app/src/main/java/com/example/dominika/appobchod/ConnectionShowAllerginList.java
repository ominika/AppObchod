...
public class ConnectionShowAllerginList extends AsyncTask<String, Void, String> {

    private Context context;

    public AsyncResponse delegate = null;

    public ConnectionShowAllerginList(Context context) {
    ...
    protected String doInBackground(String... arg0) {
        ...
        try {
            link = "http://10.0.2.2/szpital/get_allergen.php";
